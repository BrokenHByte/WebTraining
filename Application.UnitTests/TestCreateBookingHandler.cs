...
public class TestCreateBookingHandler
{
    ...
    private readonly Application.Bookings.Commands.CreateBooking.TestCreateBookingHandler _handler;
    ...
    public TestCreateBookingHandler()
    {
        ...
        _handler = new Application.Bookings.Commands.CreateBooking.TestCreateBookingHandler(
    ...
    public async Task Handle_WhenEventIsValidAndUserExists_ShouldCreateBooking()
    {
        ...
        var eventOne = new Event { Id = _testEventId, Title = "T", StartAt = DateTime.Now.AddHours(1), TotalSeats = 10, AvailableSeats = 10};
    ...
    public async Task Handle_WhenEventAlreadyStarted_ShouldThrowBookingBeginEventException()
    {
        ...
        var eventOne = new Event { Id = _testEventId, Title = "T", StartAt = DateTime.Now.AddMinutes(-5), TotalSeats = 10, AvailableSeats = 10 };
    ...
    public async Task Handle_WithCustomBookingLimit_ShouldUseConfiguredLimit()
    {
        ...
        var handler = new Application.Bookings.Commands.CreateBooking.TestCreateBookingHandler(
            _userServiceMock.Object,
            _eventRepositoryMock.Object,
            _bookingRepositoryMock.Object,
            customOptions);
    ...
    public async Task Handle_WhenEventStartAtIsExactlyNow_ShouldThrowException()
    {
        ...
        var eventOne = new Event { Id = _testEventId, Title = "T", StartAt = DateTime.Now, TotalSeats = 10, AvailableSeats = 10 };
    ...
    public async Task Handle_WithDifferentEventsAndUsers_ShouldCreateCorrectBookings()
    {
        ...
        var event1 = new Event { Id = eventId1, Title = "T", StartAt = DateTime.Now.AddHours(1), TotalSeats = 10, AvailableSeats = 10 };
        ...
        var event2 = new Event { Id = eventId2, Title = "T", StartAt = DateTime.Now.AddHours(2), TotalSeats = 10, AvailableSeats = 10 };
